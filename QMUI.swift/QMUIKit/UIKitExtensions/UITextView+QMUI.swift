...
extension UITextView {
     ...
     */
    public func qmui_setTextKeepingSelectedRange(_ text: String) -> Void {
     ...
     */
    public func qmui_setAttributedTextKeepingSelectedRange(_ attributedText: NSAttributedString) -> Void {
        let selectedTextRange = self.selectedTextRange
