...
class QMUINavigationButton: UIButton {
    ...
    static func barButtonItem(with type: QMUINavigationButtonType, title: String, position: QMUINavigationButtonPosition, target: Any?, action: Selector?) -> UIBarButtonItem {
