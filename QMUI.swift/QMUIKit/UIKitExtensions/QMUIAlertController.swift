...
class QMUIAlertController: UIViewController {
    ...
    @objc dynamic public var alertContentMargin: UIEdgeInsets = UIEdgeInsetsMake(0, 0, 0, 0)
    
    /// alert的最大宽度，默认270。
    @objc dynamic public var alertContentMaximumWidth: CGFloat = 270
    
    /// alert上分隔线颜色，默认 UIColor(r: 211, g: 211, b: 219)。
    @objc dynamic public var alertSeperatorColor: UIColor = UIColor(r: 211, g: 211, b: 219) {
        didSet {
    ...
    @objc dynamic public var alertTitleAttributes: [NSAttributedStringKey: AnyObject] = [NSAttributedStringKey.foregroundColor: UIColor.black, NSAttributedStringKey.font: UIFontBoldMake(17), NSAttributedStringKey.paragraphStyle: NSMutableParagraphStyle(lineHeight: 0, lineBreakMode: .byTruncatingTail)] {
        didSet {
    ...
    @objc dynamic public var alertMessageAttributes: [NSAttributedStringKey: AnyObject] = [NSAttributedStringKey.foregroundColor: UIColor.black, NSAttributedStringKey.font: UIFontMake(13), NSAttributedStringKey.paragraphStyle: NSMutableParagraphStyle(lineHeight: 0, lineBreakMode: .byTruncatingTail)] {
        didSet {
    ...
    @objc dynamic public var alertButtonAttributes: [NSAttributedStringKey: AnyObject] = [NSAttributedStringKey.foregroundColor: UIColor.blue, NSAttributedStringKey.font: UIFontMake(17), NSAttributedStringKey.kern: 0 as AnyObject] {
        didSet {
    ...
    @objc dynamic public var alertButtonDisabledAttributes: [NSAttributedStringKey: AnyObject] = [NSAttributedStringKey.foregroundColor: UIColor(r: 129, g: 129, b: 129), NSAttributedStringKey.font: UIFontMake(17), NSAttributedStringKey.kern: 0 as AnyObject] {
        didSet {
            _needsUpdateAction = true
        }
    }
    ...
    @objc dynamic public var alertCancelButtonAttributes: [NSAttributedStringKey: AnyObject] = [NSAttributedStringKey.foregroundColor: UIColor.blue, NSAttributedStringKey.font: UIFontBoldMake(17), NSAttributedStringKey.kern: 0 as AnyObject] {
        didSet {
            _needsUpdateAction = true
        }
    }
    ...
    @objc dynamic public var alertDestructiveButtonAttributes: [NSAttributedStringKey: AnyObject] = [NSAttributedStringKey.foregroundColor: UIColor.red, NSAttributedStringKey.font: UIFontMake(17), NSAttributedStringKey.kern: 0 as AnyObject] {
        didSet {
            _needsUpdateAction = true
        }
    }
    ...
    @objc dynamic public var alertContentCornerRadius: CGFloat = (IOS_VERSION > 9.0 ? 13 : 6) {
        didSet {
            updateCornerRadius()
        }
    }
    ...
    /// alert按钮高度，默认44pt
    @objc dynamic public var alertButtonHeight: CGFloat = 44
    
    /// alert头部（非按钮部分）背景色，默认值是：UIColor(r: 247, g: 247, b: 247, a:1)
    @objc dynamic public var alertHeaderBackgroundColor: UIColor = UIColor(r: 247, g: 247, b: 247, a:1) {
        didSet {
    ...
    @objc dynamic public var alertButtonBackgroundColor: UIColor = UIColor(r: 247, g: 247, b: 247, a:1) {
        didSet {
            _needsUpdateAction = true
        }
    }
    ...
    @objc dynamic public var alertButtonHighlightBackgroundColor: UIColor = UIColor(r: 232, g: 232, b: 232) {
        didSet {
            _needsUpdateAction = true
        }
    }
    ...
    /// alert头部四边insets间距
    @objc dynamic public var alertHeaderInsets: UIEdgeInsets = UIEdgeInsetsMake(20, 16, 20, 16)
    
    /// alert头部title和message之间的间距，默认3pt
    @objc dynamic public var alertTitleMessageSpacing: CGFloat = 3
    
    /// sheet距离屏幕四边的间距，默认UIEdgeInsetsMake(10, 10, 10, 10)。
    @objc dynamic public var sheetContentMargin: UIEdgeInsets = UIEdgeInsetsMake(10, 10, 10, 10)
    
    /// sheet的最大宽度，默认值是5.5英寸的屏幕的宽度减去水平的 sheetContentMargin
    @objc dynamic public var sheetContentMaximumWidth: CGFloat = QMUIHelper.screenSizeFor55Inch.width - UIEdgeInsetsMake(10, 10, 10, 10).horizontalValue
    
    /// sheet分隔线颜色，默认 UIColor(r: 211, g: 211, b: 219)
    @objc dynamic public var sheetSeperatorColor: UIColor = UIColor(r: 211, g: 211, b: 219) {
        didSet {
            updateEffectBackgroundColor()
        }
    }
    ...
    @objc dynamic public var sheetTitleAttributes: [NSAttributedStringKey: AnyObject] = [NSAttributedStringKey.foregroundColor: UIColor(r: 143, g: 143, b: 143), NSAttributedStringKey.font: UIFontBoldMake(13), NSAttributedStringKey.paragraphStyle: NSMutableParagraphStyle(lineHeight: 0, lineBreakMode: .byTruncatingTail)] {
        didSet {
            _needsUpdateTitle = true
        }
    }
    ...
    @objc dynamic public var sheetMessageAttributes: [NSAttributedStringKey: AnyObject] = [NSAttributedStringKey.foregroundColor: UIColor(r: 143, g: 143, b: 143), NSAttributedStringKey.font: UIFontMake(13), NSAttributedStringKey.paragraphStyle: NSMutableParagraphStyle(lineHeight: 0, lineBreakMode: .byTruncatingTail)] {
        didSet {
            _needsUpdateMessage = true
        }
    }
    ...
    @objc dynamic public var sheetButtonAttributes: [NSAttributedStringKey: AnyObject] = [NSAttributedStringKey.foregroundColor: UIColor.blue, NSAttributedStringKey.font: UIFontMake(20), NSAttributedStringKey.kern: 0 as AnyObject] {
        didSet {
            _needsUpdateAction = true
        }
    }
    ...
    @objc dynamic public var sheetButtonDisabledAttributes: [NSAttributedStringKey: AnyObject] = [NSAttributedStringKey.foregroundColor: UIColor(r: 129, g: 129, b: 129), NSAttributedStringKey.font: UIFontMake(20), NSAttributedStringKey.kern: 0 as AnyObject] {
        didSet {
            _needsUpdateAction = true
        }
    }
    ...
    @objc dynamic public var sheetCancelButtonAttributes: [NSAttributedStringKey: AnyObject] = [NSAttributedStringKey.foregroundColor: UIColor.blue, NSAttributedStringKey.font: UIFontBoldMake(20), NSAttributedStringKey.kern: 0 as AnyObject] {
        didSet {
            _needsUpdateAction = true
        }
    }
    ...
    @objc dynamic public var sheetDestructiveButtonAttributes: [NSAttributedStringKey: AnyObject] = [NSAttributedStringKey.foregroundColor: UIColor.red, NSAttributedStringKey.font: UIFontBoldMake(20), NSAttributedStringKey.kern: 0 as AnyObject] {
        didSet {
            _needsUpdateAction = true
        }
    }
    ...
    @objc dynamic public var sheetCancelButtonMarginTop: CGFloat = 8
    
    /// sheet内容的圆角，默认值是：(IOS_VERSION >= 9.0 ? 13 : 6)，以保持与系统默认样式一致
    @objc dynamic public var sheetContentCornerRadius: CGFloat = (IOS_VERSION >= 9.0 ? 13 : 6) {
        didSet {
            updateCornerRadius()
        }
    }
    ...
    @objc dynamic public var sheetButtonHeight: CGFloat = (IOS_VERSION >= 9.0 ? 57 : 44)
    
    /// sheet头部（非按钮部分）背景色，默认值是：UIColorMakeWithRGBA(247, 247, 247, 1)
    @objc dynamic public var sheetHeaderBackgroundColor: UIColor = UIColor(r: 247, g: 247, b: 247, a: 1) {
        didSet {
            updateHeaderBackgrondColor()
        }
    }
    ...
    @objc dynamic public var sheetButtonBackgroundColor: UIColor = UIColor(r: 247, g: 247, b: 247, a: 1) {
        didSet {
            _needsUpdateAction = true
        }
    }
    ...
    @objc dynamic public var sheetButtonHighlightBackgroundColor: UIColor = UIColor(r: 232, g: 232, b: 232) {
        didSet {
            _needsUpdateAction = true
        }
    }
    ...
    /// sheet头部四边insets间距
    @objc dynamic public var sheetHeaderInsets: UIEdgeInsets = UIEdgeInsetsMake(16, 16, 16, 16)
    
    /// sheet头部title和message之间的间距，默认8pt
    @objc dynamic public var sheetTitleMessageSpacing: CGFloat = 8
    ...
    override func viewDidLayoutSubviews() {
        ...
        if (preferredStyle == .alert) {
            ...
            self.containerView.frame.setWidth(fmin(self.sheetContentMaximumWidth, view.bounds.width - sheetContentMargin.horizontalValue))
            scrollWrapView.frame.setWidth(containerView.bounds.width)
            ...
            let containerRect = CGRect(x: (view.bounds.width - containerView.bounds.width) / 2, y: screenSpaceHeight - contentHeight - IPhoneXSafeAreaInsets.bottom, width: containerView.bounds.width, height: contentHeight + (self.isExtendBottomLayout ? IPhoneXSafeAreaInsets.bottom : 0))
            containerView.frame = containerRect.applying(containerView.transform).flatted
    ...
    @objc private func handleMaskViewEvent(_ sender: AnyObject) {
...
class QMUIAlertAction: NSObject {
    ...
    @objc func handleAlertActionEvent(_ sender: AnyObject) {
...
fileprivate class QMUIAlertButtonWrapView: UIView {
    ...
    init() {
        self.button = QMUIButton()
        self.button.adjustsButtonWhenDisabled = false
        self.button.adjustsButtonWhenHighlighted = false;
